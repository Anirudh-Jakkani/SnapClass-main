...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder="E.g. Anirudh Jakkani")
            ...
            try:
                audio_data = st.audio_input("Record a short phrase like I'm present, My name is Anirudh")
            except Exception:
                st.error("Audio data failed to load.")
                ...
                if new_name:
                    with st.spinner("Creating your account..."):
                        ...
                        if encodings:
                            ...
                            st.error("Failed to extract face features. Please try again with a clearer photo.")
